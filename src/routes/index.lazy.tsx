...
function Index() {
    ...
    const topSeries = [
        {
            title: "Рипли",
            description: "Сюжет основан на приключениях Рипли, героини фильма «Чужой», и исследует ее жизнь и испытания в мире, полном опасностей.",
            image: "https://oktavaklaster.ru/media/images/bf0982e1-3d33-430a-8971-e5284851cd86.jpg", // Замените на реальный URL изображения
        },
        {
            title: "Олененок",
            description: "История о дружбе между человеком и оленем, которая проходит через множество испытаний и приключений.",
        ...
        {
            title: "Fallout",
            description: "Сериал основан на популярной игре и рассказывает о жизни выживших в постапокалиптическом мире.",
        ...
        {
            title: "Сёгун",
            description: "История о западном моряке, который оказывается в Японии во времена самураев и пытается выжить в новой культуре.",
        ...
        },
        {
            ...
            description: "Комедийный экшен о паре, которые являются шпионами, работающими на противоборствующие стороны.",
    ...
    return (
        <div id="home" className="p-2">
            <div>
                <div style={{paddingTop: '30px', paddingLeft: "30px", fontSize: "2rem", paddingBottom: "30px"}}
                     className="bg-gradient-to-r from-gray-800 to-gray-900 text-gray-300 p-8 rounded-lg shadow-lg mt-20 p-8">
                    <h1 className="text-4xl font-extrabold text-center mb-6">
                        О нас
                    </h1>
                    <p className="text-lg leading-relaxed mb-6">
                        Добро пожаловать на нашу платформу, посвященную миру фильмов и сериалов! Мы стремимся
                        предоставить
                    ...
                    <div className="bg-white p-6 rounded-lg text-gray-800 shadow-md mb-6">
                        ...
                        <ul className="list-disc list-inside space-y-3">
                            <li>
                                <Link to="/" className="font-semibold hover:underline [&.active]:font-bold"
                                      onClick={() => scrollToSection('top-movies')}>
                                    <strong>{t('Топовые фильмы 2024 года')}</strong>
                                </Link>
                                : В нашем каталоге вы найдете такие ожидаемые
                                фильмы, как <em>«Дэдпул 3»</em>, <em>«Планета обезьян: Новое царство»</em> и <em>«Годзилла
                                и
                            ...
                            <li>
                                ...
                                : Наслаждайтесь просмотром таких новинок,
                            ...
                            <li>
                                ...
                                : Откройте для себя захватывающие семейные мультфильмы,
                                такие как <em>«Головоломка 2»</em>, <em>«Муфаса: Король лев»</em> и <em>«Человек-паук:
                                Через
                                вселенные 3»</em>.
                            </li>
                        </ul>
                    ...
                    <p className="text-lg leading-relaxed mb-6">
                        Мы постоянно обновляем нашу базу данных, чтобы вы всегда могли находить самые свежие и
                        интересные
                        новинки в мире кино.
                    </p>
                    <p className="text-lg leading-relaxed">
                        Наша команда — это преданные кинолюбители, которые стремятся сделать ваш опыт максимально
                        удобным и
                ...
                <div id="top-series" style={{padding: '20px 0'}}>
                    <h2 className="text-center font-bold"
                        style={{fontSize: '2rem', marginBottom: '24px'}}>{t('Топ сериалов 2024 года')}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
