...
function Index() {
    ...
    return (
        <div id="home" className="p-2">
            <div style={{paddingTop: '30px', paddingLeft: "30px", fontSize:"2rem", paddingBottom:"30px"}} className="bg-gradient-to-r from-gray-800 to-gray-900 text-gray-300 p-8 rounded-lg shadow-lg mt-20 p-8">
